...
---------------------------------------
Version 2.5.2:
-Fixed: repacked Xffect with unity 3.5.5, no need to upgrade your project to unity4 now.
-NEW: added 7 mobile examples, open "xft_demo_mobile" scene to know more.
