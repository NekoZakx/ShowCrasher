...
public class Score : MonoBehaviour 
{
	...
	void OnGUI()
	{
		if(!GlobalVariable.endOfGame)
		{
			...
			GUI.Label(new Rect(40,80,Screen.width,Screen.height), "Viewers: " + GlobalVariable.score);
			GUI.skin.label.alignment = TextAnchor.UpperLeft; 
			GUI.Label(new Rect(40,100,Screen.width,Screen.height), "Combo Wave Hit: " + nbWaveDestroy);
		}
	}
}
